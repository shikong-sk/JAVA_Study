 ...
 */
public class TestSafe_4 implements Runnable {
    final Cinema cinema;
    List<Integer> buy;

    public TestSafe_4(Cinema cinema, List<Integer> buy) {
        this.cinema = cinema;
        this.buy = buy;
    }
    ...
    public static void main(String[] args) {
        ...
        // 多个进程共享一个资源
        Thread A = new Thread(new TestSafe_4(cinema, a), "时空");
        Thread B = new Thread(new TestSafe_4(cinema, b), "时间");
        Thread C = new Thread(new TestSafe_4(cinema, c), "时光");
        A.start();
        B.start();
        C.start();
    ...
    static class Cinema {
        ...
        public boolean Buy(List<Integer> buy) {
